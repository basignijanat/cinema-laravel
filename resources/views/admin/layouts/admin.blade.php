...
<head>
    ...
    <link href="/public/admin/css/paper-dashboard.css?v=2.0.0" rel="stylesheet" />
        ...
        <div class="logo">
            <a href="http://www.creative-tim.com" class="simple-text logo-mini">
                <div class="logo-image-small">
                    <img src="/public/admin/img/logo-small.png">
                </div>
            </a>
            <a href="http://www.creative-tim.com" class="simple-text logo-normal">
                Creative Tim
                <!-- <div class="logo-image-big">
                  <img src="/public/admin/img/logo-big.png">
                </div> -->
            </a>
        </div>
            ...
            <ul class="nav">
                <li class="active ">
                    <a href="/admin/movie">
                        ...
                        <p>@lang('backend.films')</p>
                    </a>
                </li>
                <li>
                    <a href="/admin/category">
                        <i class="nc-icon nc-diamond"></i>
                        <p>@lang('backend.genres')</p>
                    </a>
                </li>
                <li>
                    <a href="/admin/showtime">
                        <i class="nc-icon nc-pin-3"></i>
                        <p>@lang('backend.showtimes')</p>
                    </a>
                </li>
                <li>
                    <a href="./notifications.html">
                        <i class="nc-icon nc-bell-55"></i>
                        <p>@lang('backend.halls')</p>
                    </a>
                </li>
                <li>
                    <a href="./user.html">
